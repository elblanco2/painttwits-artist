...
<body>
    <header>
        ...
        <?php else: ?>
        <div class="auth-status">
            <a href="auth.php?provider=google&action=login" class="btn-login-small">artist login</a>
        </div>
        <?php endif; ?>
    </header>

    <?php if ($login_error): ?>
    <div class="error-message"><?= $login_error ?><br><small style="opacity:0.8;">Make sure you're using a Google account (Gmail or Google Workspace) that matches your registered email.</small></div>
    <?php endif; ?>
    ...
    <main>
        <section id="work" class="section">
            ...
            <div class="login-prompt">
                <p>artist login required to upload work</p><p style="font-size:0.85rem;color:#888;margin-top:0.5rem;">Use the Google account linked to your registered email</p>
